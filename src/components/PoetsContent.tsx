  ...
  return (
    <div className="poets-grid">
      {poets
        .filter((poet) => poet.published)
        .map((poet) => (
          <Link href={`/${poet.fullUrl}`} key={poet.id} className="poet-card">
            <div className="poet-image-container">
              <PoetImage
                imgUrl={poet.imageUrl}
                alt={poet.name}
...
export default function PoetsContent({
  ...
  return (
    <>
      ...
      {featuredCentury && (
        <CenturySection century={featuredCentury} title="شاعران محبوب" />
      )}
      ...
      <CategorySection title="شاعران معاصر" isOpen={false}>
        {hasCustomPoets ? (
          <div className="century-section">
            <div
              className="poets-grid-container open"
              style={{ height: "auto" }}
            >
          ...
          <div className="century-section">
            <div className="century-title-button">
              <h2 className="century-title">به زودی...</h2>
            </div>
          </div>
        )}
      </CategorySection>
      ...
      <CategorySection title="شاعران کهن" isOpen={false}>
        {otherCenturies.length > 0 ? (
          ...
          <div className="century-section">
            <div className="century-title-button">
              <h2 className="century-title">در حال بارگیری...</h2>
            </div>
          </div>
        )}
      </CategorySection>
