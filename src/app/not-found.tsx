...
export default function NotFound() {
  ...
  return (
    <div
      dir="rtl"
      className="h-screen flex flex-col items-center justify-center bg-black text-white p-4 font-vazirmatn"
    >
      <motion.div
      ...
      >
        ...
        <p className="text-xl mb-4 text-gray-300">
          احتمالا صفحه‌ای که به دنبال آن بودید وجود ندارد.
        </p>
        <p className="text-xl mb-8 text-gray-300">
          می‌توانید به صفحه اصلی بازگردید یا یک شعر تصادفی ببینید.
        </p>
